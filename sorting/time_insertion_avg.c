...
int main(void)
{
    ...
    printf("Total time taken by the insertion_sort in average case is %lf ms.\n",(double)difftime(end,start)*1000);
...
Total time taken by the insertion_sort in average case is 1000.000000 ms.
*/
/*Sample Output 2
Enter the size of the array: 320000
Total time taken by the insertion_sort in average case is 94000.000000 ms.
*/
